...
\begin{itemize}
\item Bioinformatician/data scientist with leadership and management experience in cancer immunotherapy and microbiome therapeutics. Expertise in human and microbial bioinformatics, machine learning, software development, and systems architecture. Enjoy interdisciplinary collaboration and team-building to discover life-changing therapies for patients. Passionate about educating colleagues in data best practices to facilitate data-driven decision making.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
	...
	\item 
		...
		\begin{itemize}
			\item Developed and maintained bioinformatic pipelines to enable neoepitope identification, tumor characterization, and TCR discovery for T-cell receptor therapies. Ran and interpreted bioinformatic analyses for clients.
%			\item Performed software validation of custom bioinformatics tools used for neoepitope discovery
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
	\item Human bioinformatics: bulk and single-cell RNA-Seq (transcriptomics), neoepitope identification and prioritization, T-cell receptor (TCR) and V(D)J sequencing, tumor characterization, variant calling, whole-exome sequencing
