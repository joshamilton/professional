...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
	\item Bioinformatics: 16S rRNA sequencing, amplicon sequencing, genome assembly, genome annotation, metagenomic assembly and binning, metagenome profiling, RNA-Seq, transcriptomics
	...
	\item Software Development: AWS, Bash, Benchling, Docker, Git, Github, Nextflow, package development, Python, R, Shiny, SQL
%	\item CI/CD, testing
