...
\large{913-269-7789} \\
\large{https://www.linkedin.com/in/joshamilton/}
...
\begin{itemize}
\item
Results-oriented data scientist harnessing complex data to improve the human condition, with eight years of experience beyond the PhD. I built and led the data science group at Federation Bio, where I was responsible for designing, leading, and executing data science projects from discovery to early clinical development. Effective leader and clear communicator with the ability to prioritize competing objectives and align projects accordingly.
%	\item Broadly-trained bioinformatician with nine years experience in modeling biological networks and analysis of multi-omic datasets from environmental, engineered, and host-associated microbiomes. Expertise in integrating omics datasets with metabolic network models to identify targets for manipulating microbiome function. Experience in individual and collaborative development of scientific software in Python, R, and the Unix shell using Git/Github.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
	\item
		\ressubheadingSingular{\textbf{Data Scientist I, Data Scientist II, Sr Data Scientist}, Federation Bio, Inc}{2019-present}
		\begin{itemize}
			\item Established, built, and led data science group. Managed research associates and scientists. Mentored cross-functionally.
			\item Led design and execution of data science efforts across the portfolio, including data analysis, bioinformatics, software development, data management, data engineering, and cloud computing for programs in microbiome, immunology, and oncology
			\item Served as technical expert in microbiome science, and partnered with CMC, translational medicine, clinical science, and regulatory affairs to advance discovery programs into clinical development
			\item Authored documents to support regulatory filings
			\item Identified, screened, selected, and managed contractors and CROs
			\item Led internal and external cross-functional teams in development and qualification of bioanalytical assays
			\item Designed and built bioinformatics pipelines for genome assembly, genome annotation, and metagenomic profiling, using Nextflow, Docker, R, and Python
			\item Built and optimized cloud computing infrastructure, powered by AWS
			\item Launched laboratory informatics program by implementing Benchling ELN/LIMS and establishing best practices for data management and documentation
		\end{itemize}
		
	\item
		\ressubheadingSingular{\textbf{Postdoctoral Research Associate}, UW-Madison}{2014-2019}
		\begin{itemize}
